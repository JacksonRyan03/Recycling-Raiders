...
item.pos.y=ig.system.height-item.size.y;},shuffleArray:function(array){var len=array.length;var i=len;while(i--){var p=parseInt(Math.random()*len);var t=array[i];array[i]=array[p];array[p]=t;}},newItemTable:function(){this.entityItemTable=[];this.entityItemTable.push(EntityItemCup);this.entityItemTable.push(EntityItemBag);this.entityItemTable.push(EntityItemCan);this.entityItemTable.push(EntityItemCan);this.entityItemTable.push(EntityItemCan);this.entityItemTable.push(EntityItemStar);this.entityItemTable.push(EntityItemShield);this.entityItemTable.push(EntityItemStar);this.entityItemTable.push(EntityItemStar);this.entityItemTable.push(EntityItemShield);this.entityItemTable.push(EntityItemBomb);for(var i=0;i<3;i++){this.entityItemTable.push(EntityAsteroid);}
